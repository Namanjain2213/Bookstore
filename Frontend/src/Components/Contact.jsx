...
function Contact() {
    ...
    return (
        <>
            <div>
                <Navbar/>
                <div className=' dark:bg-slate-900 dark:text-white w-screen h-screen flex justify-center items-center md:mt-[4.5rem] md:mb-14' >
                    <div className=' w-[80%] md:w-[50%]  h-fit  ' >
                        <div className='flex items-center justify-between ' >
                            <h1 className='text-xl font-bold m-4 p-2' >Contact Form</h1>
